...
PKG <- c("foreign", "data.table", "dichromat", "RColorBrewer", "lattice", "scales",  "openxlsx", "sp", "rgdal", "raster","snowfall",
         "ggplot2", "dplyr", "tidyr", "stringr", "knitr", "lubridate", "devtools", "RODBC",  "googledrive", "googlesheets4","rasterVis","classInt", "rgeos","tinytex")
for (p in PKG) {
...
cleaned.image.path1<-"//net//home2/mlee/READ-SSB-Lee-Raster_requests/images/Herring/Framework7/herring-only_2021-04-08/PII_aggregated"
months<-c("9","10","11")
...
cleaned.image.path2<-"//net//home2/mlee/READ-SSB-Lee-Raster_requests/images/Herring/Framework7/allrev-trips-catch168_2021-04-08/PII_aggregated"
