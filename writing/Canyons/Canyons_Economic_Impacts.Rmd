...
```{r top_fmp_landings_plots, results='asis', eval = top_fmp_section} 
##########################################################################
...
```{r top_fmp_revenue_figure, results='asis', eval = top_fmp_section} 
...
Figures \ref{landings_plot_by_gear} to \ref{revenue_plot_by_gear} describe landings from 2012 to 2020 that occurred within the NCSMNM boundary addition. They are disaggregated by gear to provide some insight into the possible declines in the stock of habitat in the area if fishing resumed.  Some types of gear (say midwater trawl or handline) has minimal effects on the ocean bottom compared to others (say Trawl or Dredge). Tables \ref{tab:landings_table_by_gear} and \ref{tab:revenue_table_by_gear} present totals over this five year time period.
