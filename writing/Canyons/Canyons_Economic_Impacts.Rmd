...
A reasonable baseline is the *status quo* condition.  82% of the NCSMNM is contained within the Georges Bank Deep-Sea Coral Protection Area and fishing with all gear except red crab pot/trap gear continues to be prohibited in this area in the baseline.  Table \ref{tab:baseline_revenues} summarizes the average landings and revenue (real 2020 USD), by FMP, constructed from the NMFS dealer databases.  We note that this table *includes* fishing activity that occurred in the Georges Bank Deep-Sea Coral Protection Area.   
...
kbl(Baseline_rev, booktabs=T,  align=c("l",rep('r',times=2)), digits=2, caption = "2017-2020 Average Annual Landings (millions of pounds) and Value (Millions of Real 2020 USD)")  %>%
