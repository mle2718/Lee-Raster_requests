...
---
<!-- 
This is the markdown document used to do the Economic Impacts for The Canyons and Seamounts Omnitbus.  It uses the offshoreWind package
-->
...
#name and locatin of dmis2022 flatfile.
...
```{r data_process_Canyons, child=c('data_process_Canyons.Rmd'), eval=Data_Process_Switch }
...
```{r load_REVENUEFILE_and_FIN, eval = !Data_Process_Switch} 
...
<br>
<center>
Economic Impacts for Northeast Canyons and Seamounts National Monument (NCSMNM).
<br>
</center>
<br>

GARFO is leading an omnibus amendment to the Fishery Management Plans of the MA and NE fishery Management Councils.  There are thirteen fishery management plans, plus regulations for the American Lobster and Jonah Crab fisheries that are managed in conjuncion with the ASMFC.  The proposed action would close all commercial fishing activities; Red crab and American lobster commercial fishing would be exempt until September 15, 2023. Recreational fishing activities are not affected.  

The Northeast Canyons and Seamounts (NCSMNM)were closed to fishing (except for red crab and lobster) from September 15, 2016 to June 5, 2020 by (Proclamation 9496).  It was opened to fishing beginning on June 6, 2020 (Proclamation 10049) and then closed again in October of 2021 (Proclamation 10287).  Currently, 82% of the NCSMNM Area is within the Georges Bank Deep Sea Coral Area (Habitat Omnibus Amendment 2).  The entirety of the NCSMNM is currently closed to fishing by Presidential Proclamation 10287 under the Antiquities Act.


```{r map_of_area, results='asis', eval = T} 
if(wind_area_hard_name=="Canyons"){
lease_area_map$labels$title<-"Northeast Canyons and Seamounts National Monument Addition"
}
...
### Statement of the Market Failure
...
The proposed action would close the entirety of the NCSMNM to commercial fishing. Commercial fishing for red crab can continue and American Lobster until September 15, 2023.  82% of the NCSMNM lies within the Georges Bank Deep-Sea Coral Protection Area, where commercial fishing, except with red crab pots, is currently prohibited.  

Therefore, the economic analysis focuses on the 18% of NCSMNM that is not contained with the Georges Bank Deep-Sea Coral Protection Area.

## Baseline Description

A reasonable baseline is the *status quo* condition.  Fishing, with certain exceptions, inside adjacent the Georges Bank Deep-Sea Coral Protection Area continues to be prohibited as a result of actions undertaken by the MAFMC and NEFMC.  82% of the NCSMNM is contained within the Georges Bank Deep-Sea Coral Protection Area and fishing with all gear except red crab pot/trap gear to is prohibited in this area in the baseline.  

Under the status quo, commercial fishing in the 18% of the NCSMNM not contained within the Georges Bank Deep-Sea Coral Protection Area is prohibited by Presidential Proclamation under the Antiquities Act.  As seen from historical record, future administrations can easily and quickly change the set of allowed activities in the area to include commercial fishing.  

A Net Present Value framework provides a useful framework for understanding the economic effects of changes in human activity allowed inside NCSMNM. 

The status of the habitat in NCSMNM can be thought of as a stock: the ability of the habitat to provide environmental functions may decrease after fishing occurs if bottom-contact from gear damages habitat oceanographic formation or destroys marine life.  Because fauna in the area (like deep-sea coral) grow, the habitat may regenerate after these events. However, coral and sponges are fragile, slow-growing, and relatively immobile, so even small amounts of intermittent activity may have long-lasting, negative impacts on the stock of habitat in NCSMNM.  

The economic activity in the NCSMNM can be characterized as series of flows. Each year, benefits accrue to the nation.  These may take the form of extractive uses, like commercial fishing, which may also depend on environmental status.  Briefly, high-quality habitat may make it easier to catch fish and increase the abundance of fish. Benefits may also accrue though non-extractive uses.

Understanding the NPV of economic activity in NCSMNM arising from any policy is then an exercise of discounting and summing the flows of benefits (accruing from extractive and non-extractive uses) over time. 

Under the baseline, there is a probability that fishing would be allowed in NCSMNM at some unknown point in the future.  We refrain from an assessment of when this might occur or the probability that it would occur.  However, if it does change, the extractive and non-extractive flow of benefits will change.  In particular,  additional benefits would accrue to both the fishing industry and consumers of seafood.  These would be positively related to the amount of fishing that would occur in 18% of NCSMNM.  We are unable to producer or consumer surplus measures associated with fishing inside this area; we therefore characterize the fishing that would occur inside this area. We use commercial fishing data from 2012-2016 time due to the changing status of fishing after 2016.

If commercial fishing is allowed, the stock of habitat inside NCSMNM would decline in proportion to the amount of bottom contact of the fishing effort.  Both the decrease in quality of the habitat stock and the economic costs that decline in quality are difficult to quantify.  In Oceanographer, Gilbert, and Lydonia canyons, the hard canyon walls provide habitats for sponges, corals, and other invertebrates that filter food from the water to flourish, and for larger species including squid, octopus, skates, flounders, and crabs. Major oceanographic features, such as currents, temperature gradients, eddies, and fronts, occur on a large scale and influence the distribution patterns of such highly migratory oceanic species as tuna, billfish, and sharks. They provide feeding grounds for these and many other marine species.  

Figures \ref{} to \ref{} describe revenue from 2012 to 2016 that occured within the NCSMNM boundary addition and are disaggregated by FMP and gear.  These provide insight into annual flows of benefits of resuming fishing in the NCSMNM addition and the types of firms to which those benefits would accrue *in the baseline*.  Figures \ref{} to \ref{} describe landings from 2012 to 2016 that occured within the NCSMNM boundary addition. They are disaggregated by gear to provide some insight into the possible declines in the stock of habitat in the area if fishing resumed.  Some types of gear (say midwater trawl or handline) has minimal effects on the ocean bottom compared to others (say Trawl or Dredge). 


## Economic impacts relative to the baseline

A reasonable baseline is *status quo* condition in which fishing in those areas continues to be prohibited by Presidential Proclamation.  As seen from historical proclamations, future administrations can easily and quickly change the set of allowed activities in the area to include commercial fishing.  Therefore, the baseline can be divided into two parts. The current part of the baseline is associated with the current fishing activity. The future part of the baseline includes a risk or probability that the benefits and costs associated with closing the NCSMNM to commercial fishing will be erased. The probability that this will occur is difficult to quantify. 

<!---
Estimating changes in societal welfare from fishing within in the areas of the preferred alternative is not possible. Instead we present an estimate of potential displaced revenue as an estimate of the potential scale of the industry. Baseline economic activity in the Preferred Alternative areas is estimated between 2012 – 2016. Information about fishery-related businesses and communities potentially affected by the Deep-Sea Coral Amendment can respectively be found in **SECTION**.  All monetary values discussed in this section are presented in 2020 constant dollars. --->

### The Economic Effects of the Proposed Action
The proposed action would amend thirteen RFMC-led fishery management plans and change regulations for the vessels permitted in the American Lobster fishery.  The economic impacts of the proposed action can be divided into two parts: current and future activity, each of which have costs and benefits. 

### Impacts on Current Activities 

#### Costs and Benefits of Regulation on Current Activity
The proposed action would make not changes to the types of fishing activities that can be currently conducted in the NCSMNM.  Commercial Fishing is currently closed. There are no costs of the proposed regulation on current fishing activity.  There are no benefits of regulation on the with respect to the ecosystem services currently derived from the protected areas.

### Impacts on Future Activities 

The proposed action removes the risk that future administrations will open NCSMNM to commercial fishing by presidential proclamation. The expected economic effects here are best characterized in two components:

1.  A probability that the NCSMNM will be opened to commercial fishing.  The probability that the NCSMNM will be opened to commercial fishing is difficult to quantify and not attempted here.

2:  There are economic impacts associated with opening NCSMNM to commercial fishing; this includes changes in compliance costs for the commercial fishery and changes ecosystem benefits associated with the reduced protection of the unique habitats in NCSMNM The changes in benefits associated with reduced protection and the changes in compliance costs are also difficult to describe quantitatively. 

With quantitative measures of both parts, expected economic effects of changes in future activity could be computed by simply multiplying these two parts together.  

#### Benefits of regulation on Future Activity
Relative to the baseline, the benefits of regulation is the value of preservation of habitat in the NCSMNM multiplied by the probability that the protections for NCSMNM would be lifted in the future.  

#### Costs of regulation on Future Activity
Compared to the baseline, the costs of regulation are equal to the losses in societal welfare (a combination of producer and consumer welfare) associated with the inability to fish in the NCSMNM, also multiplied by the probability that protections for NCSMNM would be lifted in the future.

We are unable to estimate the changes societal welfare from fishing within in the areas of the preferred alternative. Instead we present an estimate of potential displaced revenue as an estimate of the potential scale of the industry.   

### General Approach

To characterize the economic impacts of the second component on the fishing industry, the fishing activity that would occur in the 18% of the of the NCSMNM that is not inside the boundary of the Georges Bank Deep Sea Coral Area is described.  Fishing data from 2012-2016, a five-year period when fishing was permitted in this area, is used to do so.  The type of activity that occurred during this period represents fishing activity that would occur if the NCSMNM is open to fishing.
<!---
This shifting history makes describing fishing that occurs inside the proposed closure area difficult.  Using data from 2017-2021 to describe the baseline is not realistic because for part of this time, the fishing was prohibited.

In the baseline scenario, commercial fishing effort and revenues are equal to effort and revenues that occurred during the 2012-2016 time period.  Two adjustments are made. First, effort and revenue derived from prohibited gear[^fn_bottom_tending_FRL] in the Frank R Lautenberg Deep-Sea Coral Protection Area are subtracted from baseline revenue.  This area was implemented in 2017.  Second, effort and revenue derived from prohibted gear [^fn_bottom_tending_NEFMC] in the Georges Bank Deep-Sea Coral Protection Area. are subtracted from baseline revenue.

[^fn_bottom_tending_FRL]:Bottom-tending otter trawls; bottom-tending beam trawls; hydraulic dredges; non-hydraulic dredges; bottom-tending seines; bottom-tending longlines; sink or anchored gill nets; and pots and traps except those used to fish for red crab and American lobster.

[^fn_bottom_tending_NEFMC]:The gear restrictions are nearly identical and red crab pot/trap gear is allowed in the Georges Bank Deep-Sea Coral Protection Area. However, lobster trap/pot gear is prohibited in the Georges Bank Deep-Sea Coral Protection Area.
--->
...
### Changes in revenues under the proposed action.

*Future activity*: The proposed action reduces the probability that commercial fishing will be allowed in NCSMNM.  Ecosytem benefits associated with these areas are preserved and compliance costs for regulated fishing firms, relative to a situation in which fishing allowed continue.



### Output 2: Which fisheries experience those changes in revenues.

### Output 3: How does this breakdown occur across the small firms and large firms.
I can construct "Permit-Revenues(by species)" in the proposed areas from 2011-2015 (Left).  I can merge to small and large firms; I have a "Firm-Permit-Small-Type" in 2021 (Right).  Merge=1 is small problem this foregone fishing activity that is not associated with active firms; but I supposed this is okay.  Merge=2 are firms that are active now, but not fishing in the NortheastCanyons.  Merge=3 is expected.
...
The directly regulated entities are the firms that currently hold at least 1 Northeast US fishing permit that could be used to fish in the Northeast Canyons and Seamounts. A few permit categories (Lobster: A1, A2, A4, A5, A5W, A6, and AOC; General Category Scallop B) were not included when constructing the set of directly regulated entities because these permit categories to not enable a vessel to fish in the Northeast Canyons and Seamounts areas.  There are a total of 1,338 small firms and 11 Large firms.  1,024 of the small firms derive the majority of their revenue from commerical fishing operations.  314 derive the majority of their revenue from for-hire recreational activities.  Firms that are classified as "for-hire" may still fish commerically -- these firms are included in the tabulation of directly regulated entities, although their main sourc of income (for-hire fishing) would not be directly impacted  by the proposed action. 
...
Directly_Regulated_Entities_table <- Directly_Regulated_Entities %>%
  ...
  mutate(across(c(`Firms`,`Vessels`, `Avg Gross Receipts`,`Average For-Hire Receipts`,`25th pct Gross Receipts`, `75th pct Gross Receipts`), ~ format(.x, big.mark = ",")))
...
RFA requires using the trailing three years to determine whether an entity is small or large.  Using this time period (2019-2021) would underestimate the importance of the NCSMNM to these firms, because the area was not open to fishing for much of this time.  Therefore, the fishing activity during the 2012-2016 time period are used characterize the importance of NCSMNM.  Only commercial fishing activity is described. Table \ref{tab:Firm_average_in_Area} describes the Gross Receipts from all sources and from just within the NCSMNM addition. Table \ref{tab:AnyInside} describes the Gross Receipts from all sources and from just within the NCSMNM addition only for firms that fished inside the NCSMNM addition area.  None of the firms classified as "For-Hire" firms were active inside the NCSMNM addition area.

Tables \ref{tab:Firm_average_in_Area}  and \ref{tab:AnyInside} suggest that the additional NCSMNM area are not often used by fishing firms.  Compliance costs, measured as foregone revenue from this area, are expected to be low.  On average, firms derived less than 1\% of fishing revenue from this area.
...
DRE_2012_2016Firms <- Firm_activity %>%
  ...
  summarise(Firms=n_distinct(affiliate_id),
            ...
            "Average Gross Receipts NCSMNM"=round(mean(TRinside, na.rm=T),0),
            "Average % inside NCSMNM"=percent(mean(`Percent inside NCSMNM`), accuracy=.01 ) ) %>%
    mutate(across(c(`Firms`,`Average Gross Receipts`, `Average Gross Receipts NCSMNM`), ~ format(.x, big.mark = ","))) 
...
kbl(DRE_2012_2016InsideOnly, digits=0,booktabs=T,  align=c("l",rep('r',times=6)), caption =   "Yearly Average and Total Revenues (2012-2016), RFA Directly Regulated Entities that are Active in the NCSMNM")  %>%
    #column_spec(5:8, width = "2cm")
    kable_styling(full_width = T)
...
# Box plots of firm revenue inside the Zone.  No point in doing it like this -- instead, merge it to the exisitng bit.s

Firm_totals<-Firm_activity %>%
  filter(Type !="NO_REV") %>%
  group_by(Size,Year,affiliate_id) %>%
  summarise("Gross Receipts"=round(sum(TotalREV),0),
            "Gross Receipts NCSMNM"=round(sum(InsideREV),0),
  ) %>%
  mutate("Percent NCSMNM" = `Gross Receipts NCSMNM`/`Gross Receipts`)

z<- "Small"

firm_boxplot <- Firm_totals %>% filter(Size==z)
 
boxplot <- ggplot(data = firm_boxplot, aes(x = Year, y = `Percent NCSMNM`, fill=Year)) +
  ...
  coord_flip() +
  labs(title = paste0("Small Firms Annual Revenue Percentage Boxplots"),
       x = NULL,
...
print(boxplot)
ggsave(file.path(root.image.path,paste0("affiliate_",z,".png")), plot = boxplot)
rm(boxplot)
...
```{r Firm_Totals_in_Area, eval=FALSE}
DRE_2012_2016Sum <- Firm_activity %>%
  filter(Type !="NO_REV") %>%
  group_by(Size, Type, Year) %>%
  summarise(Firms=n_distinct(affiliate_id),
            "Total Gross Receipts"=round(sum(TotalREV),0),
            "Total Gross Receipts NCSMNM"=round(sum(InsideREV),0),
  ) %>%
  mutate(`Percent in NCSMNM`=percent(`Total Gross Receipts NCSMNM`/`Total Gross Receipts`, accuracy=.01)) %>%
    mutate(across(c(`Firms`,`Total Gross Receipts`,`Total Gross Receipts NCSMNM`), ~ format(.x, big.mark = ","))) 

kbl(DRE_2012_2016Sum, booktabs=T,  align=c("l",rep('r',times=5)), caption = "Yearly Total Revenues (2012-2016), RFA Directly Regulated Entities")  %>%
      kable_styling(full_width = T)
...
```{r DRE_FMP_level, eval=FALSE}
#FMP LEVEL REVENUES
REVENUE_TOT <- REVENUEFILE %>%
  filter(Year>=2012 & Year<=2016) %>%
   filter(!FMP %in% c("SERO FMP","Highly Migratory Species","No Federal FMP"))%>%
    group_by(FMP) %>%
    summarise(TotalLanded=sum(QTYKEPT),
            TotalValue=sum(REVENUE)) %>%
    replace_na(list(TotalValue = 0, TotalLanded=0))%>%
  ungroup()
...
top_five_fmp_names <- REVENUEFILE  %>%
  ...
  filter(Area != "Other") %>% 
 filter(!FMP %in% c("SERO FMP","Highly Migratory Species","No Federal FMP"))%>%
  dplyr::select(FMP, InsideREV, InsideLANDED, PERMIT, Area, DEALNUM) %>%
  group_by(FMP) %>%
  dplyr::summarize(
  ...
  mutate(FMP_CONF = ifelse(FMP == "Red Crab", 'All Others', FMP)) %>% #rebin red crab
  ungroup() %>%
  group_by(FMP_CONF) %>%
  dplyr::summarize(
  ...
  dplyr::select(FMP,  yfa_rev, yfa_land) %>% 
  # group_by(FMP, Area) %>% 
  group_by(FMP) %>% 
  dplyr::summarize(
...
piifmpsppnm_allyrs <- REVENUEFILE  %>%
  filter(Year>=2012 & Year<=2016) %>%
  filter(Area != "Other") %>% 
  dplyr::select(FMP, SPPNM, InsideREV, InsideLANDED, PERMIT, DEALNUM) %>% # for dealers
  group_by(FMP, SPPNM) %>%
  dplyr::summarize(
    InsideREV = sum(InsideREV, na.rm = T),
    InsideLANDED = sum(InsideLANDED, na.rm = T),
...
```{r other_impacted_fmps_dynamic_text, results='asis', echo=FALSE, eval = other_fmp_section} 
...
ifelse(any(otherfmpsnames %in% "All Others"), paste0("The category \"All Others\" refers to FMPs with less than three permits or dealers impacted to protect data confidentiality. "),"."),  rounded_message)
...
quantOtherScale <-  scale_fill_viridis(discrete=TRUE) +
...
cat("We analyzed select species due to their economic importance in the area and to isolate them from combined FMPs. The select species are: ", select_species_names,". The category \"All Others\" refers to species with less than three permits or dealers impacted to protect data confidentiality. ", " ", rounded_message, "\n\n\n") 
...
We also analyzed the percentage of each firm's total commercial fishing revenue coming from within the NCSMNM addition area (Figure \ref{fig:percent_of_revenue_by_firm}).  

<br> 

```{r percent_of_revenue_by_firm, results='asis', eval = T}  
...
### ggplot version ###
  ...
  scale_fill_viridis(discrete=TRUE) +
  coord_flip() +
  labs(title = paste0("Annual Firm Revenue Percentage Boxplots, ", broadz),
       x = NULL,
       y = "Percent Total Revenue by Firm") +
  theme_bw() +
  # theme_classic() + # remove panel background and gridlines
  # theme(text=element_text(family="serif"),
  theme(text=element_text(size=10),
...
### ggplot version ###
  ...
  # scale_y_continuous(breaks = seq(4.5, 8.0, 0.5)) +
    scale_fill_viridis(discrete=TRUE) +
  coord_flip() +
  labs(title = paste0("Annual Firm Revenue  Boxplots, ", broadz),
       x = NULL,
       y = "Revenue ('000s) by Firm") +
  theme_bw() +
  # theme_classic() + # remove panel background and gridlines
  # theme(text=element_text(family="serif"),
  theme(text=element_text(size=10),
...
for (zone in allZones) {
  ...
  allsppnm_table <- allareasppnm_table %>% 
    filter(Area == zone) %>% 
    arrange(desc(Year), desc(`Revenue as % of Total`))
