...
RHS4 = basemap_RHS[basemap_RHS$Id==4,]
      ...
      print(jcons+ layer(sp.lines(CAI_grnd)) + layer(sp.lines(CAII_grnd))
            + layer(sp.lines(NLS_grnd))+ layer(sp.lines(RHS1)) + layer(sp.lines(RHS2))
            +layer(sp.lines(RHS3))+layer(sp.lines(RHS4)) + 
              layer(sp.polygons(basemap_eastcoast, fill=mylandfill))
...
##### 
      ...
      print(rclassed+ layer(sp.lines(CAI_grnd)) + layer(sp.lines(CAII_grnd))
            + layer(sp.lines(NLS_grnd))+ layer(sp.lines(RHS1)) + layer(sp.lines(RHS2))
            +layer(sp.lines(RHS3))+layer(sp.lines(RHS4)) + 
              layer(sp.polygons(basemap_eastcoast, fill=mylandfill))            #+ layer(grid.text(my.regime,draw=TRUE,x=unit(0.80, "npc"),y=unit(0.10, "npc"), just="left",gp=gpar(fontsize=12, cex=1.5)))
            #+ layer(grid.text(my.gear,draw=TRUE,x=unit(0.82, "npc"),y=unit(0.075, "npc"), just="left",gp=gpar(cex=1.5)))
            + layer(grid.text(my.month,draw=TRUE,x=unit(0.80, "npc"),y=unit(0.05, "npc"), just="left",gp=gpar(fontsize=12, cex=1.5)))
